    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent to_result = new Intent(meal_menu.this , result.class);  // result is the last layout
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i)
                {
                    case 0 :
                      ...
                      result.result_menus.add(new menu( R.drawable.kapapmeal, getString(R.string.meal_menu_layout_kebab_meal) ,"48" ));
                    ...
                    case 1 :
                        ...
                        result.result_menus.add(new menu( R.drawable.halfstchiken, getString(R.string.meal_menu_layout_chicken_meal) ,"40" ));
                    ...
                    case 2 :
                        ...
                        result.result_menus.add(new menu( R.drawable.sashtawakmeal,getString(R.string.meal_menu_layout_shish_tawook),"30" ));
                    ...
                    case 3 :
                        ...
                        result.result_menus.add(new menu( R.drawable.maksgrilmeal ,getString(R.string.meal_menu_layout_mix_grill),"35" ));
                    ...
                    case 4 :
                        ...
                        result.result_menus.add(new menu( R.drawable.kapadameal ,getString(R.string.meal_menu_layout_grilled_liver),"20" ));
                    ...
                    case 5 :
                        ...
                        result.result_menus.add(new menu( R.drawable.stchikenmeal , getString(R.string.meal_menu_layout_grilled_chicken) ,"25" ));
