    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent to_result = new Intent(pizza_menu.this , result.class);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i)
                {
                    case 0 :
                        ...
                        result.result_menus.add(new menu( R.drawable.magrita ,getString(R.string.pizza_menu_layout_Margherita_Pizza) ,"24" ));
                    ...
                    case 1 :
                        ...
                        result.result_menus.add(new menu( R.drawable.stchkin ,getString(R.string.pizza_menu_layout_Chicken_Pizza) ,"35" ));
                    ...
                    case 2 :
                        ...
                        result.result_menus.add(new menu( R.drawable.meat , getString(R.string.pizza_menu_layout_Meat_Pizza) ,"31" ));
                    ...
                    case 3 :
                        ...
                        result.result_menus.add(new menu( R.drawable.chesse , getString(R.string.pizza_menu_layout_Cheese_Pizza) ,"29" ));
                    ...
                    case 4 :
                        ...
                        result.result_menus.add(new menu( R.drawable.tona , getString(R.string.pizza_menu_layout_Tuna_pizza) ,"33" ));
                    ...
                    case 5 :
                        ...
                        result.result_menus.add(new menu( R.drawable.ganabary , getString(R.string.pizza_menu_layout_Shrimp_pizza),"43" ));
